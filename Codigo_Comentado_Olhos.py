#Algoritmo que realiza a localização dos olhos atraves 
...
xml_name = 'haarcascade_eye_tree_eyeglasses.xml'
...
while(not cv2.waitKey(20) & 0xFF == ord('s')):
        ...
        olhos = clf.detectMultiScale(gray)         #Classifica
        for x, y, w, h in olhos:                   #Desenha retangulos nos olhos
            cv2.rectangle(frame, (x, y), (x+w, y+h), (0, 0, 255), 2)
        cv2.imshow('Detector de Olhos',frame)        #Plota a imagem 
